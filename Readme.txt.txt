...
---------------------------------
- API_TEST_V2/          Carpeta principal del proyecto Django
- api/                  Aplicación donde se encuentra la API
- api/models.py         Definición del modelo Company
- api/views.py          Lógica de la API (CRUD)
- api/urls.py           Rutas específicas de la API
